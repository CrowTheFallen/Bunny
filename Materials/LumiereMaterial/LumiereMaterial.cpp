...
LumiereMaterial::LumiereMaterial(string name) :


	MaterialGL(name)
{
	
	vp = new GLProgram(MaterialPath+"LumiereMaterial/Main-VS.glsl", GL_VERTEX_SHADER);
	fp = new GLProgram(MaterialPath+"LumiereMaterial/Main-FS.glsl", GL_FRAGMENT_SHADER);
...
LumiereMaterial::~LumiereMaterial()
{
	
}

void LumiereMaterial::render(Node *o)
{
...
void LumiereMaterial::animate(Node* o, const float elapsedTime)
{
	/**********************************************
	*
	* TP 2 - A completer
